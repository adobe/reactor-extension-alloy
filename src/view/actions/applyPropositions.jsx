...
const applyPropositionsForm = form({},[
  ...
  dataElement({
    name: "propositions",
    label: "Propositions",
    description: "Provide a data element that resolves to an array of propositions to render. Enter \"%event.propositions%\" if this is an action of a Send event complete event."
  }),
  textField({
    name: "viewName",
    label: "View name",
