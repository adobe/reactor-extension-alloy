...
class Api {
    ...
    async companies(imsOrgId) {
        ...
        return matchingOrg.companies.map(company => ({label: company.companyName, value: company.globalCompanyId}));
    }
...
export default token => {
    ...
    if (token === "X34DF56GHHBBFFGH") {
        // go to launch.adobe.com, login, and then in the console do "copy(userData.imsAccessToken)", paste that below for testing
        token = "...";
