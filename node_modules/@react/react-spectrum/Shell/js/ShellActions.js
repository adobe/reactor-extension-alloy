...
function (_Component) {
  ...
  function ShellHeaderActions() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ShellHeaderActions)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "state", {
      openIndex: -1
    });

    _defineProperty(_assertThisInitialized(_this), "handleMenuOpen", function (e, index) {
      _this.setState({
        openIndex: index
      });
    });
  ...
  _createClass(ShellHeaderActions, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          betaFeedback = _this$props.betaFeedback,
          otherProps = _objectWithoutProperties(_this$props, ["className", "children", "betaFeedback"]);

      var openIndex = this.state.openIndex;
      var index = 0;
      return _react["default"].createElement("div", _extends({
        className: (0, _classnames["default"])('coral3-Shell-header-actions', className)
      }, otherProps), betaFeedback, _react["default"].createElement("div", {
        className: "coral3-Shell-menubar"
      }, children && _react["default"].Children.map(children, function (child) {
        if (_typeof(child) === 'object' && child && child.type) {
