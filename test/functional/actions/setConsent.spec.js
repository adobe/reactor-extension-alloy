...
const inputMethodFormRadio = spectrum.radio("consentChoiceConstantRadio");
const inputMethodDataElementRadio = spectrum.radio(
  "consentChoiceDataElementRadio"
);
...
const dataElementField = spectrum.textField("consentChoiceDataElementField");
