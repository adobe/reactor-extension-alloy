...
import applyPropositionsForm from "../../../src/view/actions/applyPropositionsForm";
import runVisitor from "../helpers/form/runVisitor";
...
test("It works", async () => {
  //runVisitor(applyPropositionsForm, createTestFieldVisitor({}));
});
*/
