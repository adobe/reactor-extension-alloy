...
describe('Visitor migration', () => {
  ...
  it.skip('waits for Visitor to be initialized before running', async () => {
    ...
    const ecid = getReturnedEcid(requests[0]);
    
    // This is the ID returned from the mock visitor extension
    expect(ecid).toBe("00781847927133700121980094732316198575");
  });
}); 