...
const SPECIFIC_DATASTREAM = /\/edge\/datasets\/datastreams\/records\/64c31a3b-d031-4a2f-8834-e96fc15d3030/;
const CONFIG_OVERRIDES_DATASTREAM = /\/edge\/datasets\/datastreams\/records\/aca8c786-4940-442f-ace5-7c4aba02118e/;

export const basic = () => {
  createHandlers([
    createHandler('GET', SPECIFIC_DATASTREAM, {
      data: {
...
export const withConfigOverrides = () => {
  createHandlers([
    createHandler('GET', CONFIG_OVERRIDES_DATASTREAM, {
      data: {
              ...
              event: [
                {
                  ...
                  primary: true,
                  xdmSchema: 'https://ns.adobe.com/unifiedjsqeonly/schemas/c5d1823f0f13c7f52d1ae0a5e29157616835710bc7dcf68b',
...
export const withConfigOverridesAndDisabledServices = () => {
  createHandlers([
    createHandler('GET', CONFIG_OVERRIDES_DATASTREAM, {
      data: {
        title: 'Test Config Overrides',
...
export const withConfigOverridesAndAbsentServices = () => {
  createHandlers([
    createHandler('GET', CONFIG_OVERRIDES_DATASTREAM, {
      data: {
        title: 'Test Config Overrides',
...
export const notExist = () => {
  createHandlers([
    createHandler('GET', SPECIFIC_DATASTREAM, {}, 404)
  ]);
};

export const unauthorized = () => {
  createHandlers([
    createHandler('GET', DATASTREAM_ENDPOINT_REGEX, {
      error_code: '401013',
