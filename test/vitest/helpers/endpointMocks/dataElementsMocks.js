...
export const notFound = () => {
  createHandlers([
    createHandler('GET', DATA_ELEMENTS_REGEX, {}, 404)
  ]);
};

export const single = () => {
  createHandlers([
    createHandler('GET', DATA_ELEMENTS_REGEX, {
...
export const none = () => {
  createHandlers([
    createHandler('GET', DATA_ELEMENTS_FIRST_PAGE_REGEX, {
...
export const secondPageWithOne = () => {
  createHandlers([
    createHandler('GET', DATA_ELEMENTS_SECOND_PAGE_REGEX, {
